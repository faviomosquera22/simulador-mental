      ...
      <div className="mx-auto flex max-w-7xl gap-3 px-3 pb-6 pt-14 sm:gap-6 sm:px-4 md:pt-6">
        ...
        <main className="flex-1 rounded-2xl border border-[#d9e7e1] bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(243,249,246,0.98))] p-5 shadow-[0_24px_70px_rgba(99,126,118,0.16)] backdrop-blur-xl">
          <div className="relative mx-auto w-full max-w-6xl">
            ...
            <section className="mt-5 rounded-2xl border border-slate-200 bg-white/78 p-4">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  <div className="text-sm text-slate-500">Hub de generación de casos</div>
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    ...
                    <span className="rounded-full border border-cyan-300/25 bg-cyan-300/10 px-3 py-1 text-xs text-cyan-700">
                ...
                <div className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs text-slate-500">
                  Banco visible por filtro: <span className="font-semibold text-slate-900">{filteredCatalog.length}</span> / {MEDICAL_CASE_CATALOG.length}
                </div>
              </div>
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 lg:grid-cols-[1.3fr_1fr]">
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                  <div>
                    <label className="text-[11px] text-slate-400">Dificultad</label>
                    <select
                      value={cfgDifficulty}
                  ...
                  <div>
                    <label className="text-[11px] text-slate-400">Duración objetivo</label>
                    <select
                  ...
                  <div>
                    <label className="text-[11px] text-slate-400">Escenario clínico</label>
                    <select
              ...
              <div className="mt-3 rounded-xl border border-cyan-300/20 bg-cyan-300/10 p-3 text-xs text-cyan-700">
            ...
            {!caseObj && (
              <section className="mt-5 rounded-2xl border border-dashed border-slate-200 bg-white/78 p-6 text-center">
              ...
              <section className="mt-5 rounded-2xl border border-slate-200 bg-white/82 p-5">
                <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1.6fr_1fr]">
                  <div className="rounded-2xl border border-slate-200 bg-white p-4">
                    <div className="text-xs uppercase tracking-wider text-slate-400">Resumen clínico</div>
                    ...
                    <div className="mt-3 rounded-xl border border-slate-200 bg-white p-3">
                      ...
                      <div className="mt-1 text-sm text-slate-800">{cfgChiefComplaint || essentials.chiefComplaint || "—"}</div>
                      <div className="mt-3 text-xs text-slate-400">Contexto breve</div>
                      <div className="mt-1 text-sm text-slate-600">{cfgContext || essentials.summary || "—"}</div>
                    </div>
                  </div>

                  <div className="space-y-3">
                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                      <div className="text-xs uppercase tracking-wider text-slate-400">Riesgo educativo</div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                      <div className="text-xs uppercase tracking-wider text-slate-400">Datos del caso</div>
                      <div className="mt-2 flex flex-wrap gap-2">
                        ...
                        <span className="rounded-full border border-cyan-300/25 bg-cyan-300/10 px-2.5 py-1 text-xs text-cyan-700">
                ...
                <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4">
                  <div className="text-xs uppercase tracking-wider text-slate-400">Objetivo docente</div>
                  <div className="mt-2 text-sm text-slate-800">{cfgLearningObjective || essentials.learningObjective || "—"}</div>
                  {isPediatricCase && (
                    <div className="mt-3 rounded-xl border border-cyan-300/25 bg-cyan-300/10 p-3 text-xs text-cyan-700">
            ...
            <section className="mt-5 rounded-2xl border border-slate-200 bg-white/82 p-5">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-cyan-300/40 sm:w-[320px]"
                />
              </div>
            ...
            {showConfig && (
              <div className="fixed inset-0 z-50">
                <div className="absolute inset-0 bg-white/90" onClick={() => setShowConfig(false)} />
                  ...
                  >
                    <div className="border-b border-slate-200 px-4 py-4 sm:px-6 sm:py-5">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div>
                          <div className="text-sm text-slate-500">Configurar caso de patologías</div>
                    ...
                    <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4 sm:px-6 sm:py-5">
                      {configStep === 1 && (
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                          <div className="rounded-2xl border border-slate-200 bg-white p-4">
                            ...
                            <label className="mt-3 block text-xs text-slate-500">Contexto clínico breve</label>
                            <textarea
                              value={cfgContext}
                              onChange={(e) => setCfgContext(e.target.value)}
                              className="mt-1 min-h-[140px] w-full resize-none rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm outline-none"
                            />
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-4">
                              <div className="text-xs uppercase tracking-wider text-slate-400">Alerta docente</div>
                              <div className="mt-2 text-xs text-slate-600">
                                Urgencia base del caso:{" "}
                                <span className="font-semibold text-slate-900">{selectedCard?.urgency ?? "—"}</span>
                              </div>
                              {isPediatricCase && (
                                <div className="mt-2 rounded-xl border border-cyan-300/25 bg-cyan-300/10 p-2 text-xs text-cyan-700">
                      ...
                      {configStep === 2 && (
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                          <div className="rounded-2xl border border-slate-200 bg-white p-4">
                            ...
                            <div className="mt-3 grid grid-cols-2 gap-2">
                              <div>
                                <label className="text-xs text-slate-500">Escenario clínico</label>
                                <select
                                  value={cfgCareSetting}
                                  onChange={(e) => setCfgCareSetting(e.target.value as CareSettingValue)}
                                  className="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm outline-none"
                              ...
                              <div>
                                <label className="text-xs text-slate-500">Foco formativo</label>
                                <select
                            ...
                            <div className="mt-3">
                              <label className="text-xs text-slate-500">Enfoque de entrevista</label>
                              <select
                                value={cfgApproach}
                            ...
                            <div className="mt-4 rounded-2xl border border-cyan-300/20 bg-cyan-300/10 p-3">
                              <div className="text-xs font-semibold uppercase tracking-wider text-cyan-700/90">
                              ...
                              <div className="mt-2 flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2">
                                <div>
                                  <div className="text-sm font-medium text-slate-900">Activar ECG en el caso</div>
                                  <div className="text-[11px] text-slate-400">Integrar trazados ECG como herramienta de decisión.</div>
                                </div>
                                <button
                                  type="button"
                                  onClick={() => setCfgEcgEnabled((prev) => !prev)}
                                  className={`relative inline-flex h-7 w-12 items-center rounded-full border transition ${
                                    cfgEcgEnabled ? "border-cyan-200/30 bg-cyan-200/80" : "border-slate-200 bg-slate-100"
                                  }`}
                                >
                                  <span
                              ...
                              <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
                                <div>
                                  <label className="text-xs text-slate-500">Tipo de visualización</label>
                                  <select
                                    value={cfgEcgViewMode}
                                    onChange={(e) => setCfgEcgViewMode(e.target.value as ECGViewMode)}
                                    disabled={!cfgEcgEnabled}
                                    className="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs outline-none disabled:opacity-50"
                                  >
                                ...
                                <div>
                                  <label className="text-xs text-slate-500">Selección del ECG</label>
                                  <select
                                ...
                                <div>
                                  <label className="text-xs text-slate-500">Dificultad ECG</label>
                                  <select
                                ...
                                <div>
                                  <label className="text-xs text-slate-500">ECG manual</label>
                                  <select
                              ...
                              <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-slate-600">
                                <label className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2.5 py-2">
                                  <input
                                    type="checkbox"
                                ...
                                <label className="col-span-2 flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2.5 py-2">
                                  <input
                                    type="checkbox"
                          ...
                          <div className="space-y-3">
                            <div className="rounded-2xl border border-slate-200 bg-white p-4">
                              <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2">
                                <div>
                                  ...
                                  <div className="text-xs text-slate-500">Sugerencias durante la entrevista</div>
                                </div>
                                <button
                                  type="button"
                                  onClick={() => setCfgTutorEnabled((v) => !v)}
                                  className={`relative inline-flex h-7 w-12 items-center rounded-full border transition ${
                                    cfgTutorEnabled ? "border-white/20 bg-white/85" : "border-slate-200 bg-slate-100"
                                  }`}
                                >
                                  <span
                                    className={`inline-block h-5 w-5 rounded-full bg-slate-400 transition ${
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-4">
                              <div className="text-xs uppercase tracking-wider text-slate-400">Resumen de parámetros</div>
                              <div className="mt-2 text-xs text-slate-600">
                                Escenario: {prettyCareSetting(cfgCareSetting)}
                              </div>
                              ...
                              <div className="mt-2 rounded-xl border border-cyan-300/20 bg-cyan-300/10 px-2.5 py-2 text-xs text-cyan-700">
                      ...
                      {configStep === 3 && (
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                          <div className="rounded-2xl border border-slate-200 bg-white p-4">
                            <label className="text-xs text-slate-500">Motivo de consulta (1 línea)</label>
                            <input
                            ...
                            <label className="mt-3 block text-xs text-slate-500">Objetivo docente</label>
                            <textarea
                          ...
                          <div className="space-y-3">
                            <div className="rounded-2xl border border-slate-200 bg-white p-4">
                              <div className="text-xs uppercase tracking-wider text-slate-400">Validación rápida</div>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-4">
                              <div className="text-xs uppercase tracking-wider text-slate-400">Checklist antes de iniciar</div>
